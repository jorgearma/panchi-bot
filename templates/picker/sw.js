...
self.addEventListener('fetch', event => {
  ...
  // App shell del picker — network-first con fallback a caché
  if (url.pathname === '/picker') {
    event.respondWith(networkFirst(request));
    return;
  }

  // Endpoints de datos (/picker/mis-pedidos, etc.) — network only, sin caché
