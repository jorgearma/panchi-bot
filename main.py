...
def agregar_pedido_confirmacion():
    ...
    if request.method == 'POST':
        ...
        confirmacion_url = f"https://29f9-62-116-223-170.ngrok-free.app/confirmacion_pago?pedido_id={pedido_id}" 
...
def agregar_pedido():
    ...
    if request.method == 'POST':
        ...
        payment_data = {
            ...
            'completeUrl': f"https://29f9-62-116-223-170.ngrok-free.app/pago_confirmado?pedido_id={redisID}",
            'customer': {
